...
public class PricingService
{
    public PricingDetails CalculatePrice(Apartment apartment, DateRange period)
    {
        ...
        foreach(Amenity amenity in apartment.Amenities)
        {
            ...
            {
                Amenity.WiFi => 0.05m,
                Amenity.AirConditioning or Amenity.Parking => 0.03m,
                Amenity.Spa or Amenity.Gym => 0.02m,
                _ => 0
            };
        }
        ...
        return new PricingDetails(priceForPeriod, apartment.CleaningFee, 
            amenitiesUpCharge, totalPrice);
    }
}
